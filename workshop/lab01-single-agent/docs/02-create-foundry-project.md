...
![Microsoft Foundry sidebar showing newly created project under Resources with Models and Agents sections](images/02-foundry-sidebar-new-project.png)
...
![VS Code Model Catalog showing gpt-4.1 model card with Deploy button](images/02-model-catalog-gpt41.png)
...
![Azure Portal Access Control IAM page showing Add Role Assignment for Azure AI User](images/02-azure-portal-iam-add-role.png)
