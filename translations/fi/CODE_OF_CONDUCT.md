# Microsoft avoimen lähdekoodin käytännesäännöt

Tämä projekti noudattaa [Microsoftin avoimen lähdekoodin käytännesääntöjä](https://opensource.microsoft.com/codeofconduct/).
...
- Ota yhteyttä osoitteeseen [opencode@microsoft.com](mailto:opencode@microsoft.com) kysymyksissä tai huolissa
