...
The complete working solution is the [`agent/`](../../../../workshop/lab01-single-agent/agent) folder inside this lab. This is the same code that the **Microsoft Foundry extension** scaffolds when you run `Microsoft Foundry: Create a New Hosted Agent` - customized with the executive summary instructions, environment configuration, and tests described in this lab.
