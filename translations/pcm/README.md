...
| 7 | Deploy for Foundry | [06-deploy-to-foundry.md](workshop/lab02-multi-agent/docs/06-deploy-to-foundry.md) |
...
## Permission dem wey you need (quick reference)
...
> **Important:** Azure `Owner` and `Contributor` roles get only *management* permissions, no be *development* (data action) permissions. You go need **Azure AI User** or **Azure AI Owner** to build and deploy agents.
...
- [Wetin hosted agents be?](https://learn.microsoft.com/azure/foundry/agents/concepts/hosted-agents)
